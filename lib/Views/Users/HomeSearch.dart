...
class HomeSearch extends StatefulWidget {
  const HomeSearch({Key? key,required this.titleString}) : super(key: key);
    ...
    setState(() {
      ...
      if(_selectedIndex ==0)
      {
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) => HomeSearch(titleString: widget.titleString)));
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      FutureBuilder<List<Product>>(
        future: ProductController.fetchAllProductsByTitle(widget.titleString),
